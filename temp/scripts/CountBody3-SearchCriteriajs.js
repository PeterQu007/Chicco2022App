...
function buildTabDescription(n) {
    var t = "Results",
        i;
    return n != null && (typeof n.result == "object" && typeof (n.result.listingCount != "undefined") && n.result.listingCount > 0 ? t = "Results (" + n.result.Count + " Records for " + n.result.listingCount + " Listings)" : (i = typeof n.result == "object" ? n.result.Count : n.result,
            t = "Results (" + i + ")")),
        t
}
...
function CheckBeforeMove(n, t) {
    return removeFavorite || removeRecycleBinItem ? !0 : n.get_type(t).indexOf("favorites") > -1 ? (movingIntoFavorites = !0,
        !0) : n.get_type(t).indexOf("recycle") > -1 ? (movingIntoRecycleBin = !0,
        !0) : !1
}
    ...
    $.ajax({
        ...
        success: function () {
            var t = displayFavsMsg && displayRecycleMsg ? "Saved Favorites and Recycle Bin" : displayFavsMsg ? "Saved Favorites" : "Saved Recycle Bin",
                i = "SUCCESS",
                r, u;
            displayFavsMsg && (r = $(n).find("a").first().attr("viewid"),
                u = $(n).find("a").first().text(),
                movingIntoFavorites ? (i = "Favorite Added",
                    t = u + " moved to Favorites  <br/><br/> <a style='cursor:pointer' class='undoAddFav' rel='" + r + "' ><i class='fa fa-undo' style='font-size: 12px; color: #fff;'><\/i> Undo<\/a>") : removeFavorite && (i = "Favorites Updated",
                    t = u + " removed from Favorites <br/><br/> <a style='cursor:pointer' class='undoRemoveFav' rel='" + r + "' ><i class='fa fa-undo' style='font-size: 12px; color: #fff;'><\/i> Undo<\/a>"));
...
(function (n) {
    ...
    i = n.fn[r] = n[r] = function (i) {
        var r, o, f, s, h, e;
        if (i = i || {},
            n("#min" + t + i.minName).remove(),
            r = t + i.minName,
            i.preiframe = !0,
            i.href = "#div" + r,
            i.minBoxClass = "MinimizedBox",
            o = n("#" + r),
            o.length == 0)
            f = n("<iframe frameborder='0' style='width:100%; height:100%; border:0; display:block'/>")[0],
            f.id = f.name = r,
            f.src = i.minUrl,
            i.scrolling || (f.scrolling = "no"),
            u && (f.allowtransparency = "true"),
            n("<div id='div" + r + "' class='LoadedContent'><\/div>").html(f).appendTo("#cboxContent"),
            i.dialogSelect && i.dialogSelect.dialog({
                autoOpen: !1,
                draggable: !1,
                modal: !1,
                resizable: !1,
            ...
            if (n("#div" + r).show(),
                s = o.attr("src"),
                !i.minClicked && i.dialogSelect)
                return i.dialogSelect.dialog("open"),
                    null;
            i.alwaysOverwrite && i.minUrl != s && (document.getElementById(r).contentWindow.location.href = i.minUrl)
        }
        return i.minClicked = !1,
            i.onClosed = function () {
                n.fn.minbox.minimize(i)
            },
            h = n.fn.colorbox(i),
            e = document.getElementById(r).contentWindow,
            e != null && e.SetupButtons != null && e.SetupButtons(),
            h
    };
    i.minimize = function (i) {
        ...
        if (u.length > 0) {
            for (u.hide(),
                r = 0; r < 999; r++)
                if (n("div.MinimizedBox[pos=" + r + "]").length == 0)
                    break;
            f = r * 155;
        ...
        i = function () {
            ...
            try {
                ...
                if (n('.f-mutex-item[f="' + t.attr("f") + '"]').each(function (t, i) {
                    ...
                    i = t.attr("id"),
                    i == "f_4004_Low" || i == "f_4004_High")
                    if (t.val().length > 0)
                        n('tr[rel="f_4004"],tr[rel="f_4004_DaysForward"]').remove();
                    else {
                        n('tr[rel="f_4004"]').remove();
                        return
                    }
                if (i = t.attr("id"),
                    i == "f_4006_Low" || i == "f_4006_High")
                    if (t.val().length > 0)
                        n('tr[rel="f_4006"],tr[rel="f_4006_DaysBack"],tr[rel="f_4006_RunFrom"]').remove();
                    else {
                ...
                if (i.indexOf("DaysForward") > -1 && (n('tr[rel="f_4004"],tr[rel="f_4004_DaysForward"]').remove(),
                        t.val().length < 1))
                    return;
                f = i == "f_4006_RunFrom";
                f && (n('tr[rel="f_4006"],tr[rel="f_4006_DaysBack"],tr[rel="f_4006_RunFrom"]').remove(),
                    t.is(":checked") ? n("#f_4006_DaysBack,#f_4006_Low,#f_4006_High").val("").attr("disabled", "disabled").addClass("ui-state-disabled") : n("#f_4006_DaysBack,#f_4006_Low,#f_4006_High").removeAttr("disabled").removeClass("ui-state-disabled"));
                u = !1;
                f && (e = t.attr("critsumvalue"),
                    t.prop("checked") || t.hasClass("cs-required") || e != null && e.length > 0 ? u = !1 : (u = !0,
                        t.prop("checked") || t.hasClass("cs-required") || (s = n(".f-cs-items"),
                            o = s.find('tr[rel="' + this.id + '"]'),
                            o != null && n(o).remove(),
                            t.attr("data-suppress-autocount") !== "true" && n.focusFx && n.focusFx.searchFormAutoCount && n.focusFx.searchFormAutoCount())));
                u || (r.call(this),
                    t.attr("data-suppress-autocount") !== "true" && n.focusFx && n.focusFx.searchFormAutoCount && n.focusFx.searchFormAutoCount(!0))
            } finally {
                try {
                    resizeReports()
                } catch (h) {}
    ...
    n.fn.removeRow = function (t) {
        ...
        function w() {
            if (i.hasClass("acfb-input")) {
                ...
                n("#" + r + "_Low,#" + r + "_High,#" + r + "_Low" + u + ",#" + r + "_High" + u).val("")
        }
        ...
        var e = !0,
            ...
            u = "",
            o, i, f, c, l, s;
        if (r.indexOf("__") > -1 && (o = r.split("__"),
                r = o[0],
                u = "__" + o[1]),
            i = n("#" + r + u),
            i.length == 0 && (i = n("#" + r + "_Low" + u),
                i.length == 0 && (i = n("#" + r + "_Low"))),
            i.length == 0 && (i = n("#" + r + "_Low__1"),
                i.length > 0 && (u = "__1")),
            !!t == !1) {
            if (i.hasClass("f-form-price"))
                y();
            else if (i.hasClass("acfb-value")) {
                if (f = [],
                    i[0].name.indexOf("hdnf_492") > -1) {
                    ...
                    i[0].name.indexOf("hdnf_518") > -1 && n.focusFx.$mapTab && n.focusFx.$mapTab.length > 0 && !n.focusFx.isSrcEmpty(n.focusFx.$mapTab) && (c = JSON.parse(i[0].value),
                        n.each(c, function (t, i) {
                            n.focusFx.$mapTab[0].contentWindow.$.bkfsMap.deleteShape(i.Value.id, !0)
                        }));
                p(f)
            } else
                i.hasClass("f-form-min") || i.hasClass("f-form-max") ? w() : i.hasClass("f-checkboxlist") || i.hasClass("f-cs-item") && i.attr("type") == "checkbox" ? b() : i.is("select") ? (i[0].selectedIndex = 0,
                    i[0].name.indexOf("f_12") > -1 && (e = !1)) : i.val("");
    ...
    n.fn.addRow = function (t) {
        function p(t) {
            var o = n(t).parents("ul.acfb-holder"),
                i = o.find(".acfb-input"),
                f, e, c;
            if (i && o.css("display") == "none" && i.attr("disabled"))
                n(".f-cs-items").addCustomRow(i.attr("id"), "", "", null, !1);
            else if (i) {
                var s = n(t).val(),
                    ...
                    r = "",
                    u = "Data";
                return i.attr("data") !== undefined && (u = i.attr("data")),
                    f = "Description",
                    i.attr("description") != undefined ? f = i.attr("description") : i.attr("desc") != undefined && (f = i.attr("desc")),
                    i.attr("extraparams") != undefined && (e = JSON.parse(i.attr("extraparams")),
                        e.DoRequiredInputCheck != null && (h = e.DoRequiredInputCheck)),
                    c = u.length == 0,
                    n.each(l, function (n, t) {
                        t != null && (!h && t.Required != null && t.Required && (k = !0),
                            r += r.length > 0 ? ", " : "",
                            r += c ? t : i.data("combinedataanddesc") ? t[u] + " - " + t[f] : t[u])
                    }),
                    i.data("combinedataanddesc") && r.length > 300 && (r = r.substr(0, 300) + "..."),
                    r
            }
        }
        ...
        function it() {
            ...
            return n("input", h).each(function (t) {
                ...
                f = parseInt(f, 10) * 1e3 + parseInt(s, 10),
                r = parseInt(r, 10) * 1e3 + parseInt(o, 10),
                r > 0 && f > 0 ? e = r + " - " + f : f > 0 ? e = " <= " + f : r > 0 && (e = ">=" + r),
                e
        }
        ...
        function d() {
            ...
            return (t.lastClassMin = !1,
                ...
                n.each(e, function (i, o) {
                    ...
                    s.hasClass("f-form-min") || t.noMinMaxClass && t.lastClassMin ? (s.hasClass("acfb-input") || s.hasClass("acfb-value") ? s.hasClass("acfb-value") && (r = p(o)) : r = s.val(),
                        r != "" && u.length >= 3 && (h = " " + n("#" + u[0].name).val() + ":" + n("#" + u[1].name).val() + " " + n("#" + u[2].name).val(),
                            r += h),
                        t.lastClassMin = !0,
                        t.lastClassMax = !1) : s.hasClass("f-form-max") || t.noMinMaxClass && t.lastClassMax ? (s.hasClass("acfb-input") || s.hasClass("acfb-value") ? s.hasClass("acfb-value") && (f = p(o)) : f = s.val(),
                        f != "" && u.length == 3 && (h = " " + n("#" + u[0].name).val() + ":" + n("#" + u[1].name).val() + " " + n("#" + u[2].name).val()),
                        f != "" && u.length == 6 && (h = " " + n("#" + u[3].name).val() + ":" + n("#" + u[4].name).val() + " " + n("#" + u[5].name).val()),
                        f += h,
                        t.lastClassMin = !1,
                        t.lastClassMax = !0) : (t.lastClassMin = !1,
                        t.lastClassMax = !1)
                }),
        ...
        var i = n(t),
            s, h, a, y, f, l;
        i.hasClass("f-form-field-options") && (i = i.parent().find(".f-cs-item:not(.f-form-address-num,.f-form-address-dir):first"),
            t = i[0]);
        var u = i.attr("id"),
        ...
        if (i.hasClass("f-form-price"))
            ...
            r = p(t),
            s = n("input.acfb-input", i.parent()),
            h = n("label[for=" + s.attr("id") + "]"),
            s.hasClass("f-form-min") || s.hasClass("f-form-max") ? (r = d(),
                u = e.attr("for")) : h.length > 0 && (o = (h.html() != o ? o + ": " : "") + h.html());
        else if (typeof i.attr("csText") != "undefined" && i.attr("csText").length > 0)
            r = i.attr("csText");
        else if (i.hasClass("f-form-min") || i.hasClass("f-form-max"))
            r = d(),
            u = e.attr("for");
        else if (i.attr("type") == "checkbox")
            a = i.attr("critsumvalue"),
            a != null && a.length > 0 ? (u = e.attr("for"),
                r = rt()) : r = n("#f_4006_RunFromDate").length > 0 ? n("#f_4006_RunFromDate").val() : i.prop("checked") ? "YES" : "NO";
        else if (i.attr("name").indexOf("DaysBack") > 0)
            r = t.value + " days back";
        else if (i.attr("name").indexOf("Selection") > 0)
            r = n("#" + i.attr("name") + " :selected").text();
            ...
            c != undefined ? (u = c.attr("id"),
                r = n("#" + c.attr("name") + " :selected").text() + ", " + tt) : (u = i.attr("name"),
                r = i.attr("value"))
        } else
            r = i.val();
        return i.hasClass("f-form-address-num") || i.hasClass("f-form-address-dir") || (y = w.find("select.f-form-field-options"),
                y.length > 0 && (f = n("option:selected", y),
                    l = !1,
                    b && f.val() > 0 ? (r = "",
                        l = !0) : !b && r.length > 0 && f.val() > 1 && (l = !0),
                    l && f.text() !== "Single" && (r = f.text() + " " + r))),
            n(this).addCustomRow(u, o, r, null, k)
    };
    n.fn.addCustomRow = function (t, i, r, u, f) {
        return this.each(function () {
                n("tr[rel*=hdn" + t + "]:not([class^=hotsheet])").remove();
                var u = n(this.rows).filter('[rel="' + t + '"]');
                r.length > 0 && u.length == 0 ? ($row = n("<tr><\/tr>"),
                    $row.attr("rel", t),
                    $row.addClass(i.toLowerCase().replace(" ", "")),
                    f ? ($row.addClass("cs-required"),
                        $td = n('<th scope="row" class="f-cs-action"><\/th>'),
                        $row.append($td)) : ($td = n('<th scope="row" class="f-cs-action"><div class="f-cs-close" title="Remove"><\/div><\/th>'),
                        $row.append($td)),
                    $td = n('<th scope="row" class="f-cs-action"><div class="f-cs-edit" title="Edit"><\/div><\/th>'),
                    $row.append($td),
                    $td = n('<td class="f-cs-description">' + i + "<\/td>"),
                    $row.append($td),
                    $td = n('<td class="f-cs-data">' + r + "<\/td>"),
                    $row.append($td),
                    n("tr:last", this).length > 0 ? n("tr:last", this).after($row) : n(this).append($row),
                    n(".f-cs-edit", $row).click(function () {
                        ...
                        r = "";
                        i.indexOf("__") > -1 && (u = i.split("__"),
                            i = u[0],
                            r = "__" + u[1]);
                        t = n("#" + i + r);
                        t.length == 0 && (t = n("#" + i + "_Low" + r),
                            t.length == 0 && (t = n("#" + i + "_Low")));
                        t.length == 0 && (t = n("#" + i + "_Low__1"),
                            t.length > 0 && (r = "__1"));
                        t.hasClass("acfb-value") && (t = t.parent().find(".acfb-input"));
                        t.length > 0 && (t.parents("fieldset:first").find("span.ui-icon-circle-triangle-s").parent().click(),
                            t.focus().parents("div.f-form-field").effect("highlight", {}, 3e3),
                            f = t.offset().top,
                            n("html,body").animate({
                                scrollTop: f
                            }, 1e3))
...
! function () {
    ...
    JQClass.extend = function t(i) {
        ...
        n = !1;
        for (r in i)
            if ("function" == typeof i[r] && "function" == typeof o[r])
                e[r] = function (n, t) {
                    return function () {
                        var r = this._super,
                            i;
    ...
    JQClass.classes.JQPlugin = JQClass.extend({
        ...
        _getMetadata: function (elem) {
            ...
            try {
                ...
                for (key in data)
                    data.hasOwnProperty(key) && (value = data[key],
        ...
        option: function (t, i, r) {
            ...
            var f = t.data(this.name),
                u = i || {};
            return !i || "string" == typeof i && "undefined" == typeof r ? (u = (f || {}).options,
                u && i ? u[i] : u) : void(t.hasClass(this._getMarker()) && ("string" == typeof i && (u = {},
                    u[i] = r),
    ...
    n.JQPlugin.createPlugin({
        ...
        formatDate: function (n, t, i) {
            ...
            var h = i.dayNamesShort || this.defaultOptions.dayNamesShort,
                ...
                f = function (t, i) {
                    for (var r = 1; u + r < n.length && n.charAt(u + r) === t;)
                        r++;
                    return u += r - 1,
                        Math.floor(r / (i || 1)) > 1
                },
        ...
        parseDate: function (n, t, i) {
            ...
            if (t = typeof t == "object" ? t.toString() : t + "",
                t === "")
                return null;
            n = n || this.defaultOptions.dateFormat;
            i = i || {};
            ...
            var d = i.dayNamesShort || this.defaultOptions.dayNamesShort,
                ...
                r = null,
                l = function (t, i) {
                    for (var r = 1; e + r < n.length && n.charAt(e + r) === t;)
                        r++;
                    return e += r - 1,
                        Math.floor(r / (i || 1)) > 1
                },
                c = function (n, i) {
                    ...
                    if (!r)
                        throw "Missing number at position {0}".replace(/\{0\}/, f);
                    return f += r[0].length,
                        parseInt(r[0], 10)
                },
                b = function (n, i, r, u) {
                    for (var o = l(n, u) ? r : i, e = 0; e < o.length; e++)
                        if (t.substr(f, o[e].length).toLowerCase() === o[e].toLowerCase())
                            return f += o[e].length,
                                e + 1;
                    throw "Unknown name at position {0}".replace(/\{0\}/, f);
                },
                p = function () {
                    if (t.charAt(f) !== n.charAt(e))
                        throw "Unexpected literal at position {0}".replace(/\{0\}/, f);
                    f++
                },
                f = 0;
            ...
            if (u === -1 ? u = this.today().getFullYear() : u < 100 && w && (u += h === -1 ? 1900 : this.today().getFullYear() - this.today().getFullYear() % 100 - (u <= h ? 0 : 100)),
                v > -1)
                for (o = 1,
                    s = v,
                    a = this.daysInMonth(u, o); s > a; a = this.daysInMonth(u, o))
                    o++,
                    s -= a;
            if (r = this.newDate(u, o, s),
                r.getFullYear() !== u || r.getMonth() + 1 !== o || r.getDate() !== s)
                throw "Invalid date";
            return r
        },
        determineDate: function (n, i, r, u, f) {
            r && typeof r != "object" && (f = u,
                u = r,
                r = null);
            typeof u != "string" && (f = u,
                u = "");
            var e = function (n) {
                ...
                n = n.toLowerCase();
                for (var i = (n.match(/^c/) && r ? t.newDate(r) : null) || t.today(), o = /([+-]?[0-9]+)\s*(d|w|m|y)?/g, e = null; e = o.exec(n);)
                    i = t.add(i, parseInt(e[1], 10), e[2] || "d");
                return i
            };
            return i = i ? t.newDate(i) : null,
                typeof n == "undefined" ? i : typeof n == "string" ? e(n) : typeof n == "number" ? isNaN(n) || n === Infinity || n === -Infinity ? i : t.add(t.today(), n, "d") : t.newDate(n)
        },
        daysInMonth: function (n, t) {
            return t = n.getFullYear ? n.getMonth() + 1 : t,
                n = n.getFullYear ? n.getFullYear() : n,
                this.newDate(n, t + 1, 0).getDate()
        },
        ...
        iso8601Week: function (n, i, r) {
            var u = n.getFullYear ? new Date(n.getTime()) : t.newDate(n, i, r),
                f;
            return u.setDate(u.getDate() + 4 - (u.getDay() || 7)),
                f = u.getTime(),
                u.setMonth(0, 1),
                Math.floor(Math.round((f - u) / t._msPerDay) / 7) + 1
        },
        today: function () {
        ...
        _normaliseDate: function (n) {
            return n && n.setHours(12, 0, 0, 0),
                n
        },
        year: function (n, t) {
            return n.setFullYear(t),
                this._normaliseDate(n)
        },
        month: function (n, t) {
            return n.setMonth(t - 1),
                this._normaliseDate(n)
        },
        day: function (n, t) {
            return n.setDate(t),
        ...
        _applyMonthsOffset: function (i, r) {
            ...
            return n.isFunction(u) && (u = u.apply(r.elem[0], [i])),
                t.add(i, -u, "m")
        },
        _init: function () {
        ...
        _postAttach: function (i, r) {
            if (r.inline)
                r.drawDate = t._checkMinMax(t.newDate(r.selectedDates[0] || r.get("defaultDate") || t.today()), r),
                r.prevDate = t.newDate(r.drawDate),
                this._update(i[0]),
                n.fn.mousewheel && i.mousewheel(this._doMouseWheel);
            else {
        ...
        _attachments: function (i, r) {
            var u, f, e;
            if (i.off("focus." + r.name),
                r.options.showOnFocus)
                i.on("focus." + r.name, this.show);
        ...
        _autoSize: function (n, i) {
            var r, u, f;
            i.options.autoSize && !i.inline && (r = t.newDate(2009, 10, 20),
                u = i.options.dateFormat,
                u.match(/[DM]/) && (f = function (n) {
                        for (var i = 0, r = 0, t = 0; t < n.length; t++)
                            n[t].length > i && (i = n[t].length,
                                r = t);
                        return r
                    },
                    r.setMonth(f(i.options[u.match(/MM/) ? "monthNames" : "monthNamesShort"])),
                    r.setDate(f(i.options[u.match(/DD/) ? "dayNames" : "dayNamesShort"]) + 20 - r.getDay())),
                i.elem.attr("size", t.formatDate(u, r, i.getConfig()).length))
        },
        ...
        enable: function (t) {
            if (t = n(t),
                ...
                i.inline ? t.children("." + this._disableClass).remove().end().find("button,select").prop("disabled", !1).end().find("a").attr("href", "#") : (t.prop("disabled", !1),
                    i.trigger.filter("button." + this._triggerClass).prop("disabled", !1).end().filter("img." + this._triggerClass).css({
                        opacity: "1.0",
                        cursor: ""
                    }));
            ...
            if (t = n(t),
                ...
                if (u = this._getInst(t),
                    ...
                    r.parents().each(function () {
                        if (n(this).css("position") === "relative")
                            return f = n(this).offset(),
                                !1
                    });
                    i = t.css("zIndex");
                    ...
                    t.prop("disabled", !0),
                    u.trigger.filter("button." + this._triggerClass).prop("disabled", !0).end().filter("img." + this._triggerClass).css({
                        opacity: "0.5",
                        cursor: "default"
                    });
                this._disabled = n.map(this._disabled, function (n) {
        ...
        show: function (i) {
            ...
            if ((i = n(i.target || i),
                    r = t._getInst(i),
                    t.curInst !== r) && (t.curInst && t.hide(t.curInst, !0),
                    !n.isEmptyObject(r)))
                if (r.lastVal = null,
                    r.selectedDates = t._extractDates(r, i.val()),
                    r.pickingRange = !1,
                    r.drawDate = t._checkMinMax(t.newDate(r.selectedDates[0] || r.get("defaultDate") || t.today()), r),
                    r.prevDate = t.newDate(r.drawDate),
                    t.curInst = r,
                    ...
                    u = r.options.showAnim,
                    f = r.options.showSpeed,
                    f = f === "normal" && n.ui && parseInt(n.ui.version.substring(2)) >= 8 ? "_default" : f,
                    n.effects && (n.effects[u] || n.effects.effect && n.effects.effect[u])) {
                    e = r.div.data();
                    for (o in e)
                        o.match(/^ec\.storage\./) && (e[o] = r._mainDiv.css(o.replace(/ec\.storage\./, "")));
        ...
        _extractDates: function (n, i) {
            ...
            if (i !== n.lastVal) {
                for (n.lastVal = i,
                    i = i.split(n.options.multiSelect ? n.options.multiSeparator : n.options.rangeSelect ? n.options.rangeSeparator : "\x00"),
                    r = [],
                    u = 0; u < i.length; u++)
                    try {
                        if (f = t.parseDate(n.options.dateFormat, i[u], n.getConfig()),
                            f) {
                            for (o = !1,
                                e = 0; e < r.length; e++)
                ...
                return r.splice(n.options.multiSelect || (n.options.rangeSelect ? 2 : 1), r.length),
                    n.options.rangeSelect && r.length === 1 && (r[1] = r[0]),
                    r
            }
        },
        _update: function (i, r) {
            ...
            i = n(i.target || i);
            u = t._getInst(i);
            n.isEmptyObject(u) || ((u.inline || t.curInst === u) && n.isFunction(u.options.onChangeMonthYear) && (!u.prevDate || u.prevDate.getFullYear() !== u.drawDate.getFullYear() || u.prevDate.getMonth() !== u.drawDate.getMonth()) && u.options.onChangeMonthYear.apply(i[0], [u.drawDate.getFullYear(), u.drawDate.getMonth() + 1]),
                u.inline ? (e = n("a, :input", i).index(n(":focus", i)),
                    i.html(this._generateContent(i[0], u)),
                    f = i.find("a, :input"),
                    f.eq(Math.max(Math.min(e, f.length - 1), 0)).focus()) : t.curInst === u && (u.div || (u.div = n("<div><\/div>").addClass(this._popupClass).css({
                            display: r ? "none" : "static",
                            position: "absolute",
                            left: i.offset().left,
                            top: i.offset().top + i.outerHeight()
                        }).appendTo(n(u.options.popupContainer || "body")),
                        n.fn.mousewheel && u.div.mousewheel(this._doMouseWheel)),
                    u.div.html(this._generateContent(i[0], u)),
                    i.focus()))
        },
        _updateInput: function (i, r) {
            ...
            if (!n.isEmptyObject(u)) {
                ...
                for (f = 0; f < u.selectedDates.length; f++)
                    e += r ? "" : (f > 0 ? s : "") + t.formatDate(u.options.dateFormat, u.selectedDates[f], u.getConfig()),
                    o += (f > 0 ? s : "") + t.formatDate(h, u.selectedDates[f], u.getConfig());
                u.inline || r || n(i).val(e);
                n(u.options.altField).val(o);
                !n.isFunction(u.options.onSelect) || r || u.inSelect || (u.inSelect = !0,
                    u.options.onSelect.apply(i, [u.selectedDates]),
                    u.inSelect = !1)
            }
        },
        ...
        _checkOffset: function (t) {
            ...
            n(t.elem).parents().each(function () {
                return r = r || n(this).css("position") === "fixed",
                    !r
            });
            ...
            return t.div.css("position", r ? "fixed" : "absolute"),
                u = t.options.alignment,
                i = u === "topLeft" ? {
                    left: s,
                    top: o
                } : u === "topRight" ? {
                ...
                i.left = Math.max(r ? 0 : f, i.left),
                i.top = Math.max(r ? 0 : e, i.top),
                i
        },
        ...
        hide: function (i, r) {
            var u, f, e, o, s;
            i && (u = this._getInst(i),
                n.isEmptyObject(u) && (u = i),
                u && u === t.curInst && (f = r ? "" : u.options.showAnim,
                    e = u.options.showSpeed,
                    e = e === "normal" && n.ui && parseInt(n.ui.version.substring(2)) >= 8 ? "_default" : e,
                    o = function () {
                        u.div && (u.div.remove(),
                            u.div = null,
                            t.curInst = null,
                            n.isFunction(u.options.onClose) && u.options.onClose.apply(i, [u.selectedDates]))
                    },
                    u.div.stop(),
                    n.effects && (n.effects[f] || n.effects.effect && n.effects.effect[f]) ? u.div.hide(f, u.options.showOptions, e, o) : (s = f === "slideDown" ? "slideUp" : f === "fadeIn" ? "fadeOut" : "hide",
                        u.div[s](f ? e : "", o)),
                    f || o()))
        },
        _keyDown: function (i) {
            ...
            if (u.inline || u.div) {
                if (i.keyCode === 9)
                    ...
                    t.selectDate(f, n("a." + u.options.renderer.highlightedClass, u.div)[0]),
                    e = !0;
                else
                    for (o in u.options.commands)
                        if (u.options.commands.hasOwnProperty(o) && (r = u.options.commands[o],
                                r.keystroke.keyCode === i.keyCode && !!r.keystroke.ctrlKey == !!(i.ctrlKey || i.metaKey) && !!r.keystroke.altKey === i.altKey && !!r.keystroke.shiftKey === i.shiftKey)) {
                            t.performAction(f, o);
                            e = !0;
                            break
                        }
            } else
                r = u.options.commands.current,
                r.keystroke.keyCode === i.keyCode && !!r.keystroke.ctrlKey == !!(i.ctrlKey || i.metaKey) && !!r.keystroke.altKey === i.altKey && !!r.keystroke.shiftKey === i.shiftKey && (t.show(f),
                    e = !0);
            return u.ctrlKey = i.keyCode < 48 && i.keyCode !== 32 || i.ctrlKey || i.metaKey,
                e && (i.preventDefault(),
                    i.stopPropagation()),
                !e
        },
        _keyPress: function (i) {
            var r = t._getInst(i.data && i.data.elem || i.target),
                u, f;
            return !n.isEmptyObject(r) && r.options.constrainInput ? (u = String.fromCharCode(i.keyCode || i.charCode),
                f = t._allowedChars(r),
                i.metaKey || r.ctrlKey || u < " " || !f || f.indexOf(u) > -1) : !0
        },
        ...
        _keyUp: function (i) {
            var f = i.data && i.data.elem || i.target,
                r = t._getInst(f),
                u;
            if (!n.isEmptyObject(r) && !r.ctrlKey && r.lastVal !== r.elem.val())
                try {
        ...
        _doMouseWheel: function (i, r) {
            var u = t.curInst && t.curInst.elem[0] || n(i.target).closest("." + t._getMarker())[0],
                f;
            t.isDisabled(u) || (f = t._getInst(u),
                f.options.useMouseWheel && (r = r < 0 ? -1 : 1,
                    t.changeMonth(u, -f.options[i.ctrlKey ? "monthsToJump" : "monthsToStep"] * r)),
                i.preventDefault())
        },
        clear: function (i) {
            var r = this._getInst(i),
                u;
            n.isEmptyObject(r) || (r.selectedDates = [],
                this.hide(i),
                u = r.get("defaultDate"),
                r.options.selectDefaultDate && u ? this.setDate(i, t.newDate(u || t.today())) : this._updateInput(i))
        },
        getDate: function (t) {
            var i = this._getInst(t);
        ...
        setDate: function (i, r, u, f, e) {
            ...
            if (!n.isEmptyObject(o)) {
                ...
                for (o.selectedDates = [],
                    h = 0; h < r.length; h++)
                    if (s = t.determineDate(r[h], null, y, o.options.dateFormat, o.getConfig()),
                        s && (!a || s.getTime() >= a.getTime()) && (!v || s.getTime() <= v.getTime())) {
                        for (l = !1,
                            c = 0; c < o.selectedDates.length; c++)
                ...
                if (o.selectedDates.splice(o.options.multiSelect || (o.options.rangeSelect ? 2 : 1), o.selectedDates.length),
                    o.options.rangeSelect) {
                ...
                e || (this._update(i),
                    this._updateInput(i, f))
            }
        },
        isSelectable: function (i, r) {
            var u = this._getInst(i);
            return n.isEmptyObject(u) ? !1 : (r = t.determineDate(r, u.selectedDates[0] || this.today(), null, u.options.dateFormat, u.getConfig()),
                this._isSelectable(i, r, u.options.onDate, u.get("minDate"), u.get("maxDate")))
        },
        ...
        performAction: function (t, i) {
            var r = this._getInst(t),
                u;
            n.isEmptyObject(r) || this.isDisabled(t) || (u = r.options.commands,
                u[i] && u[i].enabled.apply(t, [r]) && u[i].action.apply(t, [r]))
        },
        showMonth: function (i, r, u, f) {
            var e = this._getInst(i),
                o;
            n.isEmptyObject(e) || typeof f == "undefined" && e.drawDate.getFullYear() === r && e.drawDate.getMonth() + 1 === u || (e.prevDate = t.newDate(e.drawDate),
                o = this._checkMinMax(typeof r != "undefined" ? t.newDate(r, u, 1) : t.today(), e),
                e.drawDate = t.newDate(o.getFullYear(), o.getMonth() + 1, typeof f != "undefined" ? f : Math.min(e.drawDate.getDate(), t.daysInMonth(o.getFullYear(), o.getMonth() + 1))),
                this._update(i))
        },
        changeMonth: function (i, r) {
            var f = this._getInst(i),
                u;
            n.isEmptyObject(f) || (u = t.add(t.newDate(f.drawDate), r, "m"),
                this.showMonth(i, u.getFullYear(), u.getMonth() + 1))
        },
        changeDay: function (i, r) {
            var f = this._getInst(i),
                u;
            n.isEmptyObject(f) || (u = t.add(t.newDate(f.drawDate), r, "d"),
                this.showMonth(i, u.getFullYear(), u.getMonth() + 1, u.getDate()))
        },
        _checkMinMax: function (n, i) {
            var r = i.get("minDate"),
                u = i.get("maxDate");
            return n = r && n.getTime() < r.getTime() ? t.newDate(r) : n,
                u && n.getTime() > u.getTime() ? t.newDate(u) : n
        },
        ...
        selectDate: function (i, r) {
            ...
            if (!n.isEmptyObject(u) && !this.isDisabled(i)) {
                if (f = this.retrieveDate(i, r),
                    u.options.multiSelect) {
                    for (o = !1,
                        e = 0; e < u.selectedDates.length; e++)
                    ...
                    u.options.rangeSelect ? (u.pickingRange ? u.selectedDates[1] = f : u.selectedDates = [f, f],
                        u.pickingRange = !u.pickingRange) : u.selectedDates = [f];
                u.fromSelect = !0;
        ...
        _generateContent: function (i, r) {
            ...
            for (f = n.isArray(f) ? f : [1, f],
                r.generateDate ? r.fromSelect || (r.generateDate = r.drawDate) : r.generateDate = r.drawDate,
                r.drawDate = f.length > 1 && r.fromSelect ? this._checkMinMax(r.generateDate || r.get("defaultDate") || t.today(), r) : this._checkMinMax(r.drawDate || r.get("defaultDate") || t.today(), r),
                o = t._applyMonthsOffset(t.newDate(r.drawDate), r),
                a = "",
                s = 0; s < f[0]; s++) {
                for (v = "",
                    h = 0; h < f[1]; h++)
                    v += this._generateMonth(i, r, o.getFullYear(), o.getMonth() + 1, r.options.renderer, s === 0 && h === 0),
                    t.add(o, 1, "m");
            ...
            for (c in r.options.commands)
                r.options.commands.hasOwnProperty(c) && (y("button", 'button type="button"', "button", c, r.options.renderer.commandButtonClass),
                    y("link", 'a href="javascript:void(0)"', "a", c, r.options.renderer.commandLinkClass));
            return u = n(u),
                f[1] > 1 && (w = 0,
                    n(r.options.renderer.monthSelector, u).each(function () {
                        var t = ++w % f[1];
                        n(this).addClass(t === 1 ? "first" : t === 0 ? "last" : "")
                    })),
                e = this,
                u.find(r.options.renderer.daySelector + " a").hover(function () {
                    b.apply(this);
                    ...
                    t.keyCode === 13 ? n(t.elem).change() : t.keyCode === 27 && (n(t.elem).hide().prev("select").css("visibility", "visible"),
                        r.elem.focus())
                }),
                l = {
                    elem: r.elem[0]
                },
                u.keydown(l, this._keyDown).keypress(l, this._keyPress).keyup(l, this._keyUp),
                u.find("." + r.options.renderer.commandClass).click(function () {
                ...
                r.options.isRTL && u.addClass(r.options.renderer.rtlClass),
                f[0] * f[1] > 1 && u.addClass(r.options.renderer.multiClass),
                r.options.pickerClass && u.addClass(r.options.pickerClass),
                n("body").append(u),
                p = 0,
                u.find(r.options.renderer.monthSelector).each(function () {
                    p += n(this).outerWidth()
                }),
                u.width(p / f[0]),
                n.isFunction(r.options.onShow) && r.options.onShow.apply(i, [u, r]),
                u
        },
        _generateMonth: function (i, r, u, f, e, o) {
            ...
            var g = r.options.fixedWeeks || c[0] * c[1] > 1,
                ...
                ct = t.today(),
                s = t.newDate(u, f, 1);
            for (t.add(s, -tt - (g && s.getDay() === nt ? 7 : 0), "d"),
                v = s.getTime(),
                w = "",
                b = 0; b < st; b++) {
                for (ft = ht ? '<span class="dp' + v + '">' + (n.isFunction(r.options.calculateWeek) ? r.options.calculateWeek(s) : 0) + "<\/span>" : "",
                    k = "",
                    d = 0; d < 7; d++) {
                    if (y = !1,
                        r.options.rangeSelect && r.selectedDates.length > 0)
                        y = s.getTime() >= r.selectedDates[0] && s.getTime() <= r.selectedDates[1];
                    else
            ...
            return h = this._prepare(e.month, r).match(/\{monthHeader(:[^\}]+)?\}/),
                h = h[0].length <= 13 ? "MM yyyy" : h[0].substring(13, h[0].length - 1),
                h = o ? this._generateMonthSelection(r, u, f, rt, ut, h, e) : t.formatDate(h, t.newDate(u, f, 1), r.getConfig()),
                et = this._prepare(e.weekHeader, r).replace(/\{days\}/g, this._generateDayHeaders(r, e)),
                this._prepare(e.month, r).replace(/\{monthHeader(:[^\}]+)?\}/g, h).replace(/\{weekHeader\}/g, et).replace(/\{weeks\}/g, w)
        },
        _generateDayHeaders: function (n, t) {
            for (var i, u = "", r = 0; r < 7; r++)
                i = (r + n.options.firstDay) % 7,
                u += this._prepare(t.dayHeader, n).replace(/\{day\}/g, '<span class="' + this._curDoWClass + i + '" title="' + n.options.dayNames[i] + '">' + n.options.dayNamesMin[i] + "<\/span>");
            return u
        },
        _generateMonthSelection: function (n, i, r, u, f, e) {
            var c, h;
            if (!n.options.changeMonth)
                return t.formatDate(e, t.newDate(i, r, 1), n.getConfig());
            ...
            for (c = 1; c <= 12; c++)
                (!u || t.newDate(i, c, t.daysInMonth(i, c)).getTime() >= u.getTime()) && (!f || t.newDate(i, c, 1).getTime() <= f.getTime()) && (l += '<option value="' + c + "/" + i + '"' + (r === c ? ' selected="selected"' : "") + ">" + b[c - 1] + "<\/option>");
            if (l += "<\/select>",
                p = p.replace(/\\x2E/, l),
                h = n.options.yearRange,
                h === "any")
                l = '<select class="' + this._monthYearClass + " " + this._anyYearClass + '" title="' + n.options.yearStatus + '"><option>' + i + '<\/option><\/select><input class="' + this._monthYearClass + " " + this._curMonthClass + r + '" value="' + i + '">';
            else {
                h = h.split(":");
                ...
                if (o.getTime() < s.getTime()) {
                    for (o = (u && u.getTime() > o.getTime() ? u : o).getFullYear(),
                        s = (f && f.getTime() < s.getTime() ? f : s).getFullYear(),
                        y = Math.floor((s - o) / 2),
                        (!u || u.getFullYear() < o) && v(o - y, n.options.earlierText),
                        a = o; a <= s; a++)
                        v(a);
                    (!f || f.getFullYear() > s) && v(s + y, n.options.laterText)
                } else {
                    for (o = (f && f.getTime() < o.getTime() ? f : o).getFullYear(),
                        s = (u && u.getTime() > s.getTime() ? u : s).getFullYear(),
                        y = Math.floor((o - s) / 2),
                        (!f || f.getFullYear() > o) && v(o + y, n.options.earlierText),
                        a = o; a >= s; a--)
                        v(a);
        ...
        _prepare: function (n, t) {
            var r = function (t, i) {
                ...
                u, i;
            for (r("inline", t.inline),
                r("popup", !t.inline),
                u = /\{l10n:([^\}]+)\}/,
                i = null; i = u.exec(n);)
                n = n.replace(i[0], t.options[i[1]]);
            return n
        }
    });
    t = n.datepick;
...
! function (n) {
    ...
    n.extend(n.datepick, {
        ...
        monthNavigation: function (i, r) {
            for (var c = n(this), a = r.get("renderer"), v = a.selectedClass === t.selectedClass, s = r.curMinDate(), h = r.get("maxDate"), l = r.get("monthNames"), y = r.get("monthNamesShort"), p = r.drawDate.getMonth(), f = r.drawDate.getFullYear(), o = !1, e = '<div class="' + (v ? "ui-datepicker-month-nav" : "datepick-month-nav") + '" style="display: none;">', u = 0; u < l.length; u++)
                o = (!s || new Date(f, u + 1, 0).getTime() >= s.getTime()) && (!h || new Date(f, u, 1).getTime() <= h.getTime()),
                e += "<div>" + (o ? '<a href="#" class="dp' + new Date(f, u, 1).getTime() + '"' : "<span") + ' title="' + l[u] + '">' + y[u] + (o ? "<\/a>" : "<\/span>") + "<\/div>";
            for (u = -6; u <= 6; u++)
                0 !== u && (o = (!s || new Date(f + u, 11, 31).getTime() >= s.getTime()) && (!h || new Date(f + u, 0, 1).getTime() <= h.getTime()),
                    e += "<div>" + (o ? '<a href="#" class="dp' + new Date(f + u, p, 1).getTime() + '"' : "<span") + ' title="' + (f + u) + '">' + (f + u) + (o ? "<\/a>" : "<\/span>") + "<\/div>");
            e += "<\/div>";
        ...
        selectWeek: function (t, i) {
            ...
            t.find("td.datepick-week span,td.ui-state-hover span").each(function () {
                n('<a href="#" class="' + this.className + '" title="Select the entire week">' + n(this).text() + "<\/a>").click(function () {
                    for (var u = r.datepick("retrieveDate", this), t = [u], f = 1; f < 7; f++)
                        t.push(u = n.datepick.add(n.datepick.newDate(u), 1, "d"));
                    return i.get("rangeSelect") && t.splice(1, t.length - 2),
                        r.datepick("setDate", t).datepick("hide"),
                        !1
                }).replaceAll(this)
            })
        },
        selectMonth: function (t, i) {
            ...
            t.find("th.datepick-week span,th.ui-state-hover span").each(function () {
                n('<a href="#" title="Select the entire month">' + n(this).text() + "<\/a>").click(function () {
                    for (var t = r.datepick("retrieveDate", n(this).parents("table").find("td:not(.datepick-week):not(.ui-state-hover) *:not(.datepick-other-month):not(.ui-datepicker-other-month)")[0]), u = [t], e = n.datepick.daysInMonth(t), f = 1; f < e; f++)
                        u.push(t = n.datepick.add(n.datepick.newDate(t), 1, "d"));
                    return i.get("rangeSelect") && u.splice(1, u.length - 2),
                        r.datepick("setDate", u).datepick("hide"),
                        !1
                }).replaceAll(this)
            })
        },
...
function (n) {
    ...
    function i() {
        n.isFunction(n.focusFx.processingAutocompleteCallback) && (n.focusFx.processingAutocompleteCallback(),
            n.focusFx.processingAutocompleteCallback = !1)
    }
    ...
    n.extend(n.focusFx, {
        ...
        searchForm: function () {
            ...
            function c(t, r, u, f, e, o, s, c, l) {
                ...
                var k = !0,
                    ...
                    g = !1,
                    nt = !1;
                return s == null || s.length == 0 ? s = {} : (s = JSON.parse(s),
                        s.multiple != null && (k = s.multiple),
                        s.matchCase != null && (nt = s.matchCase),
                        s.allowCommas != null && (d = s.allowCommas),
                        s.nameDescLabel != null && (g = s.nameDescLabel)),
                    y = 10,
                    p = null,
                    n(t).hasClass("f-form-erms") ? (p = function () {
                        ...
                        y = 0),
                    w = null,
                    c != null && c.length > 0 ? (v = u.split("_"),
                        window.top._cacheData != null && (a = v.length >= 4 ? v[3] : "1",
                            c == "2" ? r = window.top._cacheData[v[1]] : c == "1" ? (a.indexOf("-") >= 0 && (a = a.split("-")[0]),
                                r = window.top._cacheData[v[1]][a]) : c == "3" && a.indexOf("-") == -1 && (r = window.top._cacheData[v[1]][a]),
                            w = function (n) {
            ...
            n("form").submit(function () {
                return n.focusFx.safeSubmit ? (n.focusFx.safeSubmit = !1,
                    !0) : !1
            });
            ...
            n("a.f-form-area-map-link") && window.g_searchType != 6 && (f = n("a.f-form-area-map-link").parents()[0],
                f != null && n(f).children("ul").attr("style"));
            ...
            $expandCollapse.length > 0 && (t = "ui-icon-circle-triangle-s",
                r = "ui-icon-circle-triangle-n",
                $expandCollapse.click(function () {
                    return n(this).parent().next().slideToggle("fast"),
                        $icon = n("span.ui-icon", this),
                        $icon.hasClass(t) ? switchClassEx($icon, r, t) : switchClassEx($icon, t, r),
                        !1
                }).parent().click(function () {
                    return n(this).next().slideToggle("fast"),
                        $icon = n("a span.ui-icon", this),
                        $icon.hasClass(t) ? switchClassEx($icon, r, t) : switchClassEx($icon, t, r),
                        !1
                }),
            ...
            n(".f-form-date").datepick({
                ...
                onShow: function () {
                    ...
                    if ((t == "f_4006_Low" || t == "f_4006_High" || t == "f_4004_Low" || t == "f_4004_High") && n(this).is(":disabled")) {
                        n("#f_4006_RunFrom").prop("checked") ? n("#f_4006_RunFrom").removeAttr("checked") : (n("#f_4006_DaysBack,#f_4004_DaysForward").val(""),
                            n("#fo_f_4006,#fo_f_4004").val("").change());
            ...
            n("select.acfb-listing-owner").change(function () {
                ...
                n(this).val() == "A" ? (n(".acfb-listing-owner-agent").show(),
                    n("ul.acfb-listing-owner-agent input").removeAttr("disabled")) : n(this).val() == "AO" ? (n(".acfb-listing-owner-office").show(),
                    n("ul.acfb-listing-owner-office input").removeAttr("disabled")) : n(this).val() == "AF" && (n(".acfb-listing-owner-firm").show(),
                    n("ul.acfb-listing-owner-firm input").removeAttr("disabled"));
            ...
            typeof n.fn.criteriaSummaryValidate == "function" && (n("form input.f-form-price").criteriaSummaryValidate(function (t) {
                    ...
                    var r = n(t).attr("id").split("_", 2),
                        ...
                        f = n.trim(s.val()),
                        c = n.trim(h.val());
                    return (u != "" || o != "000") && (f != "" || c != "000") && (l = parseInt(u == "" ? 0 : u, 10) * 1e3 + parseInt(o, 10),
                        a = parseInt(f == "" ? 0 : f, 10) * 1e3 + parseInt(c, 10),
                        l > a) ? (alert("Low price cannot be greater than high price.  Removed high price."),
                        h.val("000"),
                        s.val("").focus(),
                        !1) : !0
                }),
                ...
                n("form input.f-form-date").criteriaSummaryValidate(function (n) {
                    var t = u(n),
                        i = null,
                        r = null;
                    return (t.low != "" && (i = new Date(t.low)),
                        t.high != "" && (r = new Date(t.high)),
                        r != null && r > new Date("06/06/2079")) ? (alert("End date cannot be greater than 06/06/2079.  Removed end date."),
                        t.highEl.val("").focus(),
                        !1) : i != null && i < new Date("01/01/1900") || i > new Date("06/06/2079") ? (alert("Begin date cannot be less than 01/01/1900 or greater than 06/06/2079.  Removed begin date."),
                        t.lowEl.val("").focus(),
                        !1) : i != null && r != null && i > r ? (alert("Begin date cannot be greater than end date.  Removed end date."),
                        t.highEl.val("").focus(),
                        !1) : !0
                }),
                n("form input.f-form-integer").criteriaSummaryValidate(function (n) {
                    var t = u(n),
                        i, r;
                    return t.low != "" && t.high != "" && (i = parseInt(t.low, 10),
                        r = parseInt(t.high, 10),
                        i > r) ? (alert("Min number cannot be greater than max number.  Removed max number."),
                        t.highEl.val("").focus(),
                        !1) : !0
                }),
                n("form input.f-form-integer-multiple").criteriaSummaryValidate(function (t) {
                    ...
                    for (f in u)
                        i = parseInt(u[f], 10),
                        i == "NaN" || i.toString(10).length != u[f].length ? e.push(i) : r += (r.length > 0 ? "," : "") + i;
                    return e.length > 0 ? (alert("Invalid values were removed."),
                        n(t).focus().val(r),
                        !1) : (n(t).val(r),
                        !0)
                }),
                n("form input.f-form-decimal").criteriaSummaryValidate(function (n) {
                    var t = u(n),
                        i, r;
                    return t.low != "" && t.high != "" && (i = parseFloat(t.low),
                        r = parseFloat(t.high),
                        i > r) ? (alert("Min number cannot be greater than max number.  Removed max number."),
                        t.highEl.val("").focus(),
                        !1) : !0
            ...
            n("div.f-form-field:last", n("div.fieldset")).keypress(function (t) {
                if (t.keyCode == 9 && !t.shiftKey) {
                    ...
                    n("div.fieldset:hidden", i).length > 0 && (t.preventDefault(),
                        n("div.legend", i).click(),
                        n("div.f-form-field:has(" + s + ") " + s, i).get(0).focus())
                }
            });
            ...
            n("select.f-form-field-options").selectBoxIt({
                ...
                if (t.siblings("div.f-form-date-range").length > 0) {
                    ...
                    t.attr("id") == "fo_f_4006" || t.attr("id") == "fo_f_4004" ? n.focusFx.hotSheetSetEnabled() : t.siblings("div.f-form-mixed-range-container").length > 0 && (r = t.siblings("div.f-form-mixed-range-container"),
                        i = n("input.f-form-min", r),
                        t.val() == "2" ? (i.focusMask({
                                mask: "stringMask"
                            }).removeClass("f-form-integer"),
                            n("input.f-form-max", r).val("").attr("disabled", "disabled")) : (f = i.val(),
                            f != parseInt(f, 10) && i.val(""),
                            i.focusMask({
                                mask: "intMask"
                            }).addClass("f-form-integer"),
                            n("input.f-form-max", r).removeAttr("disabled")));
        ...
        searchFormBuildData: function (t) {
            ...
            return (t.each(function () {
                    var r = n("#hdn" + n(this).attr("name")).val(),
                        t;
                    r != null && r.length > 0 && (t = "",
                        n(this).attr("data-erms-physnum") != null ? t = n(this).attr("data-erms-physnum") : (t = n(this).attr("name"),
                            t = t.substring(t.indexOf("_") + 1, t.length),
                            t.indexOf("_") >= 0 && (t = t.substring(0, t.indexOf("_")))),
                        i[i.length] = {
                            Key: t,
                            Value: JSON.parse(r)
                        })
        ...
        searchFormAutoCount: function (t) {
            if (n.focusFx.requiredFields.length > 0)
                for (var i = 0; i < n.focusFx.requiredFields.length; i++)
                    n('table.f-cs-items tr[rel="' + n.focusFx.requiredFields[i] + '"]').length > 0 ? n(n('span[title="Required"]')[i]).removeClass("im-icon-required").addClass("im-icon-not-required") : n(n('span[title="Required"]')[i]).removeClass("im-icon-not-required").addClass("im-icon-required");
        ...
        hasRequiredFields: function (t) {
            ...
            return window.g_searchType == null && (n("form.f-form-search input.required").each(function () {
                    var t, i;
                    n(this).val().length == 0 && (t = !0,
                        n(this).parent().parent().attr("class") == "f-form-date-range" && (u ? t = !1 : (i = n(this).parents("div.f-form-field").find("select.f-form-field-options"),
                                i.length > 0 && i.val() > 0 && (t = !1)),
                            u = !0),
                        t && (f = !0,
                            e[e.length] = n(this).parent().parent().parent().find("label:first").text()))
                }),
                n("form.f-form-search input.onerequired").each(function () {
                    var t, f;
                    n(this).val().length == 0 && (t = !0,
                        n(this).parent().parent().attr("class") == "f-form-date-range" && (u ? t = !1 : (f = n(this).parents("div.f-form-field").find("select.f-form-field-options"),
                                f.length > 0 && f.val() > 0 && (t = !1)),
                            u = !0),
                        t && (i = !0,
                            r[r.length] = n(this).parent().parent().parent().find("label:first").text()))
                }),
                r.length < n("form.f-form-search input.onerequired").length && (i = !1),
                i && t && n.jGrowl("One of the following fields is required:<br/><br/>" + r.join("<br/>"), {
                    header: "ALERT",
                    group: "jgrowl-alert"
                }),
        ...
        searchFormCount: function (i) {
            ...
            if (!n.focusFx.hasRequiredFields(!i)) {
                ...
                ajaxCall = new Promise((res, rej) => {
                    currentSearchCountRequest = n("form.f-form-search").ajaxSubmit({
                        url: g_urlCountAction,
                        dataType: "json",
                        headers: {
                            __RequestVerificationToken: n('input[name="__RequestVerificationToken"]').val()
                        ...
                        type: "POST",
                        timeout: 12e4,
                        success: (data) => ajaxResolve(data, res),
                        error: () => ajaxReject(rej),
                    })
                })
            }
            n.focusFx.triggerSave()
        ...
        hasRealCriteria: function () {
            ...
            return n.each(r, function (i, r) {
                    var f = r.split("="),
                        ...
                        e = f[1],
                        o, s;
                    if (u && e && (u.startsWith("f_") || u.startsWith("hdnf_") || u.startsWith("fo_f_")))
                        return (o = u.split("_"),
                            u.startsWith("fo_f_") && !n.focusFx.isDateField(o[2])) ? !0 : u == "hdnf_518" ? (s = JSON.parse(unescape(e)),
                            n.each(s, function (n, i) {
                                if (i.Value.shapeType != 6)
                                    return t = !0,
                                        !1
                            }),
                            !0) : (t = !0,
        ...
        getCurrentTab: function () {
            ...
            return !parent.$("#" + n).hasClass("ui-tabs-panel") && n.indexOf("_M") < 0 && parent.frameElement != null && (n = parent.frameElement.id),
                n
        },
        ...
        runIfSrcIsEmpty: function (t, i, r) {
            return n.focusFx.isSrcEmpty(t, i) ? (r(t),
                !0) : !1
        },
        doSubmit: function (t) {
            var u = parent,
                i = window.frameElement.id,
                r, e, f, o;
            parent.$("#" + i).hasClass("ui-tabs-panel") || (u = parent.parent,
                i = parent.frameElement.id);
            i == "HomeTab" ? (e = u.$("#app_tab_switcher a[tabDescription='Quick Search']"),
                f = buildTabDescription(t),
                e.length > 0 ? (r = e.attr("href").replace("#", ""),
                    u.$("#app_tab_switcher").tabs("select", "#" + r),
                    r += "_1",
                    u.$("a[href='#" + r + "']").html('<span class="">' + f + "<\/span>"),
                    u.$("a[href='#" + r + "']").attr("rel", f)) : r = u.loadItemMain("Quick Search", f, "about:blank", !0, "frmMain") + "_1") : window.g_replaceTabID != null && window.g_replaceTabID.length > 0 && u.$("#" + window.g_replaceTabID).length > 0 ? (i = i.substring(0, i.indexOf("_")),
                r = window.g_replaceTabID,
                window.g_replaceTabID = "",
                u.$("#" + i).tabs("select", "#" + r),
                u.$("#" + i + ' a[href="#' + r + '"] span').html(buildTabDescription(t))) : window.g_useSubSubTabForResults ? r = u.appendOrActivateSubSubTab(buildTabDescription(t), i, "#") : (o = i.substring(0, i.lastIndexOf("_")),
                i = i.substring(0, i.indexOf("_")),
                r = o + "_2",
                parent.appendSubTabGroup({
                    mainFrame: i,
                    subFrame: o,
                    curFrame: window.frameElement.id,
                    newTabId: r,
            ...
            r != null && (setupParams(r),
                n.focusFx.safeSubmit = !0,
                n.focusFx.countChangedResults = !1,
                window.setTimeout(function () {
        ...
        searchFormSubmit: function () {
            ...
            n.focusFx.hasRequiredFields(!0) || (n(".CountBtn,.SearchBtn,.ClearBtn").attr("disabled", "disabled"),
                i = g_urlCountAction,
                i == "" ? n.focusFx.doSubmit() : (i += i.indexOf("?") > -1 ? "&fromSearch=true" : "?fromSearch=true",
                    n("form.f-form-search").ajaxSubmit({
                        url: i,
                        dataType: "json",
                        headers: {
                        ...
                        success: function (t) {
                            var i = typeof t.result == "object" ? t.result.Count : t.result,
                                u;
                            t.status == "OK" ? parseInt(i, 10) > 0 ? (u = n("#ViewSelected").val(),
                                t.message != null && t.message == "MULTI_PAGE_WARNING" && (u == null || u.indexOf("Spreadsheet") > -1) ? (n.focusFx.selectCriteriaTab(),
                                    n("#LargeResults").dialog("isOpen") === !0 && n("#LargeResults").dialog("destroy"),
                                    n("#LargeResults").dialog({
                                    ...
                                    n("LargeResults").dialog("open")) : n.focusFx.doSubmit(t)) : (n.focusFx.selectCriteriaTab(),
                                n.jGrowl("No results found.  Please refine your criteria and try again.", {
                                    header: "INFO",
                                    group: "jgrowl-info"
...
$(function () {
        ...
        n.length != 0 && (f = function () {
                t.prop("checked") || $(this).val().length > 0 && (n.val(""),
                    $(t).prop("checked", ""))
            },
            $.extend($.focusFx, {
                hotSheetSetEnabled: function () {
                    var f = i.data("selectBoxIt");
                    t.prop("checked") ? (n.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        r.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        u.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        i.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        f && f.disable()) : n.val().length > 0 ? (r.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        u.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        i.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        t.prop("checked", "")) : i.length > 0 && i.val().length > 0 ? (n.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        r.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        u.val("").attr("disabled", "disabled").addClass("ui-state-disabled"),
                        t.prop("checked", "")) : (n.removeAttr("disabled").removeClass("ui-state-disabled"),
                        r.removeAttr("disabled").removeClass("ui-state-disabled"),
                        u.removeAttr("disabled").removeClass("ui-state-disabled"),
                        i.removeAttr("disabled").removeClass("ui-state-disabled"),
                        f && f.enable())
                }
            }),
            ...
            searchFormRules: function () {
                ...
                e = function () {
                    ...
                    if (u.length > 0 && u.val() != "") {
                        ...
                        for (a in s)
                            e.push(s[a].ID),
                            v = parseInt(s[a].ID.split("_")[0], 10),
                            n.inArray(v, l) == -1 && l.push(v)
                    }
                    o.length > 0 && (y = e.length > 0,
                        e.length > 0 && n.each(e, function (t, i) {
                            var r = !1;
                        ...
                        n.each(o, function (t, i) {
                            var u = n("input[id^=f_" + i + "_]"),
                                r, f;
                            u.length > 0 && (r = u.parent().parent(),
                                f = r.parent().find("a.f-form-lookup-partial"),
                                y ? (u.removeAttr("disabled"),
                                    r.removeClass("acfb-no-input"),
                                    f.show()) : (u.attr("disabled", "disabled"),
                                    r.addClass("acfb-no-input"),
                                    n("li.acfb-data", r).each(function (t, i) {
                                        n("img.p", i).click()
                                    }),
                                    f.hide()))
                        }));
                    ...
                    n.each(n.focusFx.validStatuses, function (i, r) {
                        if (r.statuses.length < t.length) {
                            ...
                            w || n.each(r.statuses, function (t, i) {
                                if (n.inArray(parseInt(i, 10), l) != -1)
                                    return u = !0,
                                        !1
                            });
                            u ? r.controlsAndLinks.removeClass("ui-state-disabled").removeAttr("disabled") : (r.controlsAndLinks.attr("disabled", "disabled").addClass("ui-state-disabled").filter("input:text").val(""),
                                n(".f-cs-items tr[rel^=f_" + r.id + "__]").remove())
                        }
                    });
                    f.length > 0 && (p = !0,
                        n.each(r, function (t, r) {
                            ...
                            if (u != null && u.lowControl.length > 0 && (u.lowControl.val() != "" || u.highControl.val() != ""))
                                return p = !1,
                                    !1
                        }),
...
$(function () {
    ...
    typeof $.fn.tree == "function" && (firstSelect = !0,
        $("#Reports,#ReportsToh").tree({
                ...
                onselect: function (n, t) {
                    ...
                    if (s != null && s.indexOf("Container") < 0) {
                        ...
                        if ($(n).attr("colorbox") == "true" && window.dataController != undefined) {
                            ...
                            $.focusFx.loadViewSelectorNode(n, !firstSelect),
                            firstSelect = !1
                    } else
                        t.toggle_branch(n)
                },
                onmove: function (n) {
                    movingIntoFavorites ? (displayFavsMsg = !0,
                        $(n).attr("rel").indexOf("recycle") > -1 && (displayRecycleMsg = !0),
                        $.tree.focused().set_type("favorites" + $(n).attr("ownerType"), n),
                        $(n).children("a.add-fav").replaceWith(removeFavHtml)) : movingIntoRecycleBin ? (displayRecycleMsg = !0,
                        $(n).attr("rel").indexOf("favorites") > -1 && (displayFavsMsg = !0),
                        $.tree.focused().set_type("recycle" + $(n).attr("ownerType"), n)) : removeFavorite ? (displayFavsMsg = !0,
                        $.tree.focused().set_type($(n).attr("ownerType"), n),
                        $(n).children("a.remove-fav").replaceWith(addFavHtml)) : removeRecycleBinItem && (displayRecycleMsg = !0,
                        $.tree.focused().set_type($(n).attr("ownerType"), n));
        ...
        $('#Reports li[rel^="recycle"]>a>ins').live("click", function (n) {
            var i = $(this).parent().parent().attr("rel").indexOf("favorites"),
                ...
                t, u;
            (i > -1 || r > -1) && $(this).parent().parent().attr("rel").toLowerCase().indexOf("item") > -1 && (n.stopPropagation(),
                removeFavorite = i > -1,
                removeRecycleBinItem = r > -1,
                t = $(this).parent().parent(),
                $.tree.focused().cut(t),
                u = $("#" + t.attr("parentHeader")),
                t.attr("rel", t.attr("ownerType")),
                $.tree.focused().paste(u) === !1 && $.jGrowl("Could not remove " + (removeFavorite ? "favorite" : "Recycle Bin") + " item from list.", {
                    header: "ALERT",
                    group: "jgrowl-alert"
                }))
        }),
    ...
    $("#Reports li.leaf").on("click", function (n) {
        n.srcElement.className.indexOf("add-fav") >= 0 || n.srcElement.parentElement.className.indexOf("add-fav") >= 0 ? (h(n),
            n.stopPropagation()) : n.srcElement.className.indexOf("remove-fav") >= 0 || n.srcElement.parentElement.className.indexOf("remove-fav") >= 0 ? (c(n),
            n.stopPropagation()) : n.srcElement.className.indexOf("modify-default-results") >= 0 ? (n.stopPropagation(),
            u()) : n.srcElement.className.indexOf("modify-default-details") >= 0 ? (n.stopPropagation(),
            f()) : n.srcElement.className.indexOf("modify-default-toh-results") >= 0 ? (n.stopPropagation(),
            o()) : n.srcElement.className.indexOf("modify-default-toh-details") >= 0 ? (n.stopPropagation(),
            s()) : n.srcElement.className.indexOf("modify-default-hotsheet-results") >= 0 && (n.stopPropagation(),
            e())
    });
...
m_VE_ReturnData = "",
        ...
        n.extend(n.focusFx, {
            ...
            getMapUrl: function () {
                var i = "?",
                    e = n("#hdnf_518").val(),
                    u, t, r, f;
                return e.length > 0 && (u = n("#Map").val(),
                        u.length > 0 && (t = JSON.parse(u),
                            i += "&Address=" + escape(t.address) + "&City=" + escape(t.city) + "&State=" + escape(t.state) + "&Zip=" + escape(t.zip) + "&MapZoom=" + t.zoom + "&CenterLat=" + t.centerLat + "&CenterLng=" + t.centerLng)),
                    r = n.focusFx.getCountObject(),
                    r.hasValidCount && (r.hasCountLessThanMaxPins && (i += "&SearchHasCountLessThenMaxPins=true"),
                        i += "&SearchCount=" + r.countResult),
                    i += "&IsFromSearch=true",
                    f = n("a.f-form-map"),
                    m_VE_ReturnData = null,
                    f.attr("href") + i + "&tabName=" + window.frameElement.id
            },
            getCountObject: function () {
                var t = {
                    ...
                    r = !1,
                    u;
                return i.length > 0 && (u = JSON.parse(i),
                        n.each(u, function (n, t) {
                            t.Value.shapeType != 6 && (r = !0)
                        })),
                    n("#CountResult").val() != "" && (t.countResult = n("#CountResult").val().replace(/,/g, ""),
                        t.hasValidCount = !0,
                        parseInt(t.countResult, 10) <= window.g_searchMaxPins && !r && (t.hasCountLessThanMaxPins = !0)),
                    t
            },
            bingSearch: function () {
                if (!window.g_hasMapTab && n("#Map").length > 0)
                    parent.$.fn.colorbox({
                    ...
                    alert('The "Mapping" search control must be added to the layout for Mapping Search to work.');
                return !1
            },
            processBingResult: function (t) {
                var i, r, u, o, s;
                if (t = t || m_VE_ReturnData,
                    t != null && typeof t == "object") {
                    t.count != "" && n.focusFx.setCount(t.count, !0);
                    var h = n("#f_518"),
                        e = h.parent().parent()[0].acfb,
                        f = [];
                    for (i = 0; i < t.shapes.length; i++)
                        r = t.shapes[i].shapeType,
                        u = "Rubberband",
                        r == "1" ? u = "Radius" : r == "4" ? u = "Polygon" : r == "5" ? u = "Map Boundary" : r == "6" ? u = "Distance" : r == "7" && (u = "Layer Item: " + t.shapes[i].description),
                        o = "Shape" + (i + 1),
                        s = {
                            ID: o,
                    ...
                    e.mergeResults(f);
                    n.focusFx.dontCountRightNow = !1;
                    t.instant === "1" && (n("#hdnf_518").addClass("f-cs-disable"),
                        n.focusFx.searchFormSubmit())
                }
            }
        })
    }(jQuery),
    function (n) {
        ...
        function t(n) {
            var t = ".",
                r = ",";
            return n == "us" || n == "ae" || n == "eg" || n == "il" || n == "jp" || n == "sk" || n == "th" || n == "cn" || n == "hk" || n == "tw" || n == "au" || n == "ca" || n == "gb" || n == "in" ? (t = ".",
                    r = ",") : n == "de" || n == "vn" || n == "es" || n == "dk" || n == "at" || n == "gr" || n == "br" ? (t = ",",
                    r = ".") : n == "cz" || n == "fr" || n == "fi" || n == "ru" || n == "se" ? (r = " ",
                    t = ",") : n == "ch" && (r = "'",
                    t = "."),
                new i(t, r, "-")
        }
        ...
        n.fn.parse = function (i) {
            ...
            return this.each(function () {
                    var t = new String(n(this).text()),
                        r, c, h, i;
                    for (n(this).is(":input") && (t = new String(n(this).val())); t.indexOf(u) > -1;)
                        t = t.replace(u, "");
                    for (t = t.replace(e, ".").replace(o, "-"),
                        r = "",
                        c = !1,
                        t.charAt(t.length - 1) == "%" && (c = !0),
                        h = 0; h < t.length; h++)
                        s.indexOf(t.charAt(h)) > -1 && (r = r + t.charAt(h));
                    i = new Number(r);
                    c && (i = i / 100,
                        i = i.toFixed(r.length - 1));
                    f.push(i)
                }),
                f
        };
        n.fn.format = function (i) {
            ...
            return this.each(function () {
                ...
                for (n(this).is(":input") && (v = new String(n(this).val())),
                    c = "",
                    d = !1,
                    t = 0; t < i.format.length; t++)
                    if (o.indexOf(i.format.charAt(t)) == -1)
                        c = c + i.format.charAt(t);
                    ...
                    break;
                for (a = "",
                    t = i.format.length - 1; t >= 0; t--)
                    if (o.indexOf(i.format.charAt(t)) == -1)
                        a = i.format.charAt(t) + a;
                    else
                        break;
                for (i.format = i.format.substring(c.length),
                    i.format = i.format.substring(0, i.format.length - a.length); v.indexOf(f) > -1;)
                    v = v.replace(f, "");
                if (s = new Number(v.replace(u, ".").replace(e, "-")),
                    a == "%" && (s = s * 100),
                    r = "",
                    tt = s % 1,
                    i.format.indexOf(".") > -1) {
                    ...
                    for (h = h.substring(h.lastIndexOf(".") + 1),
                        t = 0; t < y.length; t++)
                ...
                if (b = Math.floor(s),
                    ...
                    for (p = "",
                        p = i.format.indexOf(".") == -1 ? i.format : i.format.substring(0, i.format.indexOf(".")),
                        g = new String(Math.abs(b)),
                        nt = 9999,
                        p.lastIndexOf(",") != -1 && (nt = p.length - p.lastIndexOf(",") - 1),
                        k = 0,
                        t = g.length - 1; t > -1; t--)
                        l = g.charAt(t) + l,
                        k++,
    ...
    function (n, t, i, r) {
        ...
        e.prototype = {
                    ...
                    r.parent().find("a[rel]:first").focusOverlay({
                        ...
                        onBeforeLoad: function () {
                            ...
                            t && (t.html(e),
                                i.initElements(),
                                r = n("#hdn" + u).val(),
                                r.length > 0 && n.each(JSON.parse(r), function (n, t) {
                                    var r = t.Addr.addr,
            ...
            buildPopupMarkup: function (t, i) {
                ...
                return r.append(this.buildAddressControl()).append(this.buildHeader("Selected Addresses")).append('<div class="selected"><\/div>').append(this.buildInlineControl()),
                    r[0].outerHTML
            },
            initElements: function () {
                ...
                n(".selected", this.$container).delegate("a.f-action-edit", "click", function () {
                    var i, t, u, r;
                    n("#inlineeditor").parent().attr("id") != "inlinetemplate" && (i = n("#inlineeditor").parent(),
                        n("inlineeditor").appendTo("#inlinetemplate"),
                        n("span.f-data", i).text(n.data(i.get(0), "addr").toString()).show());
                    i = n(this).parent();
                    ...
                    u = n("#inlinename");
                    u.hasClass("acfb-input") ? (r = u.parent().parent().get(0).acfb,
                        r != null && t.nameJson != null && t.nameJson.length > 0 && t.nameJson[0].Data.length > 0 ? r.mergeResults(t.nameJson) : r != null && r.mergeResults([])) : n("#inlinename").val(t.name);
            ...
            buildAddressControl: function () {
                var r = "<table>",
                    i = ["Low", "High"],
                    n, t;
                return this.options.directionUsed && (i[i.length] = "Direction"),
                    i[i.length] = "Street Name",
                    i[i.length] = "",
                    r += "<thead>",
                    r += this.buildRow(!0, i),
                    r += "<\/thead><tbody>",
                    n = [],
                    n[0] = '<input class="f-form-integer" id="low" maxlength="10" name="low" type="text" style="width: 75px;">',
                    n[1] = '<input class="f-form-integer" id="high" maxlength="10" name="high" type="text" style="width: 75px;" >',
                    this.options.directionUsed && (n[n.length] = '<select id="direction">' + this.buildOptions(this.options.directionList) + "<\/select>"),
                    this.options.streetLookup ? (t = "<fieldset>",
                        t += '<div class="ui-widget-container fieldset">',
                        t += '  <div class="f-form-field">',
                        t += '      <ul class="ui-helper-reset acfb-holder name" data-popupdataurl="' + this.options.streetLookupPopupUrl + '" data-popuptitle="' + this.options.streetLookupPopupTitle + '" data-url="' + this.options.streetLookupUrl + '">',
                        t += '          <li><input class="ac_input acfb-input acf" id="name" name="name" type="text" autocomplete="off"><input class="acfb-value f-cs-item" id="hdnname" name="hdnname" type="hidden"><\/li>',
                        t += "      <\/ul>",
                        t += "    <\/div>",
                        t += "<\/div>",
                        t += "<\/fieldset>",
                        n[n.length] = t) : n[n.length] = '<input id="name" maxlength="50" name="name" style="width: 150px" type="text">',
                    n[n.length] = '<input type="button" value="Add" id="add" disabled="disabled">',
                    r += this.buildRow(!1, n),
                    r + "<\/tbody><\/table>"
            },
            buildInlineControl: function () {
                var n = '<div style="display:none;" id="inlinetemplate"><span id="inlineeditor">';
                return n += '<div style="float: left; width: 220px;">',
                    n += '<input class="f-form-integer" id="inlinelow" maxlength="10" name="low" type="text" style="width: 75px; margin-right: 5px;">',
                    n += '<input class="f-form-integer" id="inlinehigh" maxlength="10" name="low" type="text" style="width: 75px;">',
                    this.options.directionUsed && (n += '<select id="inlinedirection">' + this.buildOptions(this.options.directionList) + "<\/select>"),
                    n += "<\/div>",
                    n += '<input id="inlinename" maxlength="50" name="inlinename" style="float: left; width: 150px" type="text" disabled="disabled">',
                    n + '<input type="button" value="Save" id="inlinesave"/><input type="button" value="Cancel" id="inlinecancel"/><\/span><\/div>'
            },
            buildRow: function (n, t) {
                for (var i = "<tr>", r = 0; r < t.length; r++)
                    i += n ? "<th>" : "<td>",
                    i += t[r],
                    i += n ? "<\/th>" : "<\/td>";
                return i + "<\/tr>"
            ...
            getAddrName: function (t) {
                var i, r;
                return n("#hdn" + t).length > 0 && (i = n("#hdn" + t).val(),
                    i != null && i.length > 0) ? (r = JSON.parse(i),
                    r.length > 0 ? r[0].Data : "") : n.trim(n("#" + t).val())
            },
        ...
        objectEqual = function (n, t) {
            var i;
            if (typeof n === r && typeof t !== r || typeof t === r && typeof n !== r)
                return !1;
            if (typeof n === r && typeof t === r)
                return !0;
            for (i in n)
                if (typeof n[i] != "function" && (!t.hasOwnProperty(i) || n[i] !== t[i]))
                    return !1;
            for (i in t)
                if (typeof t[i] != "function" && (!n.hasOwnProperty(i) || t[i] !== n[i]))
                    return !1;
            return !0
        };
        n.fn[u] = function (t) {
    ...
    function (n, t, i) {
        ...
        n.focusOverlayMask = {
            load: function (e, c) {
                ...
                r = n("#" + e.maskId);
                r.length || (r = n("<div/>").attr("id", e.maskId),
                    n("body").append(r));
                var l = a();
                if (r.css({
                        position: "absolute",
                    ...
                    e.color && r.css("backgroundColor", e.color),
                    o(e.onBeforeLoad) === !1)
                    return this;
                if (e.closeOnEsc)
                    n(i).on("keydown.mask", function (t) {
                        t.keyCode == 27 && n.focusOverlayMask.close(t)
                    });
                if (e.closeOnClick)
                    r.on("click.mask", function (t) {
                        n.focusOverlayMask.close(t)
                    });
                n(t).on("resize.mask", function () {
                    n.focusOverlayMask.fit()
                });
                return c && c.length && (h = c.eq(0).css("zIndex"),
                        n.each(c, function () {
                            var t = n(this);
        ...
        n.fn.focusOverlayMask = function (t) {
            return n.focusOverlayMask.load(t),
                this
        };
        ...
        y.prototype = {
            init: function () {
                ...
                if (f && (typeof f == "string" && (f = {
                    ...
                    p = this.options.target || e.attr("rel"),
                    u = p ? n(p) : null || e,
                    !u.length)
                    throw "Could not find Overlay: " + p;
                typeof this.options.width == "string" && this.options.width.indexOf("%", this.options.width.length - 1) !== -1 && (w = this.options.width.replace("%", ""),
                    b = h.width() * (parseInt(w) / 100),
                    this.options.width = b);
                typeof this.options.height == "string" && this.options.height.indexOf("%", this.options.height.length - 1) !== -1 && (k = this.options.height.replace("%", ""),
                    d = h.height() * (parseInt(k) / 100),
                ...
                n.extend(r, {
                    load: function (t) {
                        ...
                        if (r.isOpened())
                            return r;
                        if (o = c[this.options.effect],
                            !o)
                            throw 'Overlay: cannot find effect : "' + this.options.effect + '"';
                        ...
                        if (typeof e == "string" && (e = e == "center" ? Math.max((h.height() - w) / 2, 0) : parseInt(e, 10) / 100 * h.height()),
                            l == "center" && (l = Math.max((h.width() - p) / 2, 0)),
                            o[0].call(r, {
                                top: e,
                                left: l
                            }, function () {
                            ...
                            f && this.options.closeOnClick)
                            n.focusOverlayMask.getMask().one("click", r.close);
                        if (this.options.closeOnClick)
                            n(i).on("click." + y, function (t) {
                                n(t.target).parents(u).length || r.close(t)
                            });
                        if (this.options.closeOnEsc)
                            n(i).on("keydown." + y, function (n) {
                    ...
                    close: function (t) {
                        ...
                        if (t = t || n.Event(),
                            ...
                            return f && u === 1 && n.focusOverlayMask.close(),
                                r
                        }
                    },
                    getOverlay: function () {
                ...
                n.each("onBeforeLoad,onStart,onLoad,onBeforeClose,onClose,onSave".split(","), function (t, i) {
                    if (n.isFunction(r.options[i]))
                        n(r).on(i, r.options[i]);
                    r[i] = function (t) {
                        if (t)
                            n(r).on(i, t);
                        return r
                ...
                l.length || this.options.save || (l = n('<button class="save">Save<\/button>'),
                    u.prepend(l));
                l.click(function (n) {
                    r.save(n)
                });
                o = u.find(this.options.close || ".close");
                o.length || this.options.close || (o = n('<button class="close">Close<\/button>'),
                    u.prepend(o));
                o.click(function (n) {
                    r.close(n)
                });
        ...
        r.prototype = {
            ...
            buildElementIfNeeded: function () {
                var t = this.$element.attr("link"),
                    u, f, i, e, r;
                n(t).length == 0 ? (n(this.options.containerId).append('<div style="display: none;"><div class="word_search_container ui-widget" id="' + t.replace("#", "") + '">'),
                    this.$container = n(t),
                    this.$container.append('<div class="wsField ui-widget-content fieldset ui-field_selection">').append('<div class="wsCriteria ui-widget-content fieldset ui-word_container">'),
                    u = n(".wsField", this.$container),
                    u.append('<div class="wsFieldTitle ui-state-default legend ui-label">Field Selection<\/div>').append('<div class="wsFieldText">Add a field to search<\/div>').append('<input type="text" class="wsFieldFilter watermark watermarkOn" watermarkValue="Search" value="Search" />').append('<input class="wsFieldAdd" type="button" title="Add" value="Add" /> <br />').append('<select class="wsWords" multiple="multiple"><\/select>'),
                    f = n(".wsCriteria", this.$container),
                    f.append('<div class="wsCriteriaTitle ui-state-default legend ui-label" >Word Search<\/div>').append('<div class="wsCriteriaClearAll"><a href="#">Clear All<\/a><\/div>').append('<div class="wsCriteriaText">Add criteria to selected field<\/div>').append('<ul  class="wsCriteriaList"><\/ul>'),
                    this.initElements()) : (this.$container = n(t),
                    this.clearAllWordCriteria());
                i = this.options.applicationTabId.$("#hdn" + this.options.fieldId).val();
                i != null && i.length > 0 && (e = JSON.parse(i),
                    r = this,
                    n.each(e, function (t, i) {
                        var e = n.trim(i.Data.split(":")[0]),
                            u = i.ID.split("__")[1],
                            f = n("#" + u);
                        f.length == 0 && (r.addSelectedWord(e, u),
                            f = n("#" + u));
                        r._uniqueId++;
            ...
            acfbuild: function (n) {
                ...
                return t = t + '<input class="acf acfb-input ac_input" type="text" id="' + n + '" name="' + n + '" value = "" url="" data="" desc="" />',
                    t = t + '<input class="acfb-hidden-values" type="hidden" name="' + i + '" id="' + i + '" value = "" />',
                    t + "<\/ul>"
            },
    ...
    function (n) {
        n.extend(n.fn, {
            livequery: function (t, i, r) {
                var f = this,
                    u;
                return n.isFunction(t) && (r = i,
                        i = t,
                        t = undefined),
                    n.each(n.livequery.queries, function (n, e) {
                        if (f.selector == e.selector && f.context == e.context && t == e.type && (!i || i.$lqguid == e.fn.$lqguid) && (!r || r.$lqguid == e.fn2.$lqguid))
                            return (u = e) && !1
                    }),
                    u = u || new n.livequery(this.selector, this.context, t, i, r),
                    u.stopped = !1,
                    u.run(),
                    this
            },
            expire: function (t, i, r) {
                ...
                return n.isFunction(t) && (r = i,
                        i = t,
                        t = undefined),
                    n.each(n.livequery.queries, function (f, e) {
        ...
        n.livequery = function (t, i, r, u, f) {
            return this.selector = t,
                ...
                this.elements = [],
                this.stopped = !1,
                this.id = n.livequery.queries.push(this) - 1,
                u.$lqguid = u.$lqguid || n.livequery.guid++,
                f && (f.$lqguid = f.$lqguid || n.livequery.guid++),
                this
        };
            ...
            run: function () {
                if (!this.stopped) {
                    var i = this,
                        ...
                        u = r.not(t);
                    this.elements = r;
                    this.type ? (u.bind(this.type, this.fn),
                        t.length > 0 && n.each(t, function (t, u) {
        ...
        n.extend(n.livequery, {
            ...
            checkQueue: function () {
                if (n.livequery.running && n.livequery.queue.length)
                    for (var t = n.livequery.queue.length; t--;)
                        n.livequery.queries[n.livequery.queue.shift()].run()
            },
            pause: function () {
        ...
        n.prototype.init = function (n, i) {
            ...
            return n && n.selector && (r.context = n.context,
                    r.selector = n.selector),
                typeof n == "string" && (r.context = i || document,
                    r.selector = n),
                r
        };
...
! function (n) {
    ...
    n.widget("selectBox.selectBoxIt", {
        ...
        _create: function (t) {
            var r = this,
                ...
                u = r.options.theme;
            if (r.element.is("select"))
                return r.widgetProto = n.Widget.prototype,
                    r.originalElem = r.element[0],
                    r.selectBox = r.element,
                    r.options.populate && r.add && !t && r.add(f),
                    r.selectItems = r.element.find("option"),
                    r.firstSelectItem = r.selectItems.slice(0, 1),
                    r.documentHeight = n(i).height(),
                    r.theme = n.isPlainObject(u) ? n.extend({}, r.getThemes()["default"], u) : r.getThemes()[u] ? r.getThemes()[u] : r.getThemes()["default"],
                    r.currentFocus = 0,
                    r.blur = !0,
                    r.textArray = [],
                    r.currentIndex = 0,
                    r.currentText = "",
                    r.flipped = !1,
                    t || (r.selectBoxStyles = r.selectBox.attr("style")),
                    r._createDropdownButton()._createUnorderedList()._copyAttributes()._replaceSelectBox()._addClasses(r.theme)._eventHandlers(),
                    r.originalElem.disabled && r.disable && r.disable(),
                    r._ariaAccessibility && r._ariaAccessibility(),
                    r.isMobile = r.options.isMobile(),
                    r._mobile && r._mobile(),
                    r.options["native"] && this._applyNativeSelect(),
            ...
            return (t.options.showFirstOption || (t.selectItems.first().attr("disabled", "disabled"),
                    ...
                    t.selectItems.each(function (l) {
                        ...
                        f.is("optgroup") && (o = "selectboxit-optgroup-option",
                            0 === i.index() && (s = '<span class="selectboxit-optgroup-header ' + f.first().attr("class") + '"data-disabled="true">' + f.first().attr("label") + "<\/span>"));
                        ...
                        this.selected && (t._setText(t.dropdownText, p || r),
                            t.currentFocus = l)
                    }),
        ...
        _replaceSelectBox: function () {
            ...
            return t.selectBox.css("display", "none").after(t.dropdownContainer),
                ...
                t.options.autoWidth && (t.dropdown.css({
                        width: "auto"
                    }).css({
                ...
                "number" === n.type(o) && (t.maxHeight = t.listAnchors.outerHeight(!0) * o),
                t
        },
        _scrollToView: function (n) {
            var t = this,
                ...
                o = Math.abs(i),
                u = t.list.height();
            return "search" === n ? r > u - i ? t.list.scrollTop(f + (i - (u - r))) : -1 > i && t.list.scrollTop(i - r) : "up" === n ? -1 > i && t.list.scrollTop(f - o) : "down" === n && r > u - i && t.list.scrollTop(f + (o - u + r)),
                t
        },
        _callbackSupport: function (t) {
            var i = this;
            return n.isFunction(t) && t.call(i, i.dropdown),
                i
        },
        ...
        close: function (n) {
            var t = this,
                ...
                f = t.options["native"],
                e = t.isMobile;
            return f || e || !t.list.is(":visible") || (t.triggerEvent("close"),
                    "none" === i ? t.list.hide() : "hide" === i || "slideUp" === i || "fadeOut" === i ? t.list[i](r) : t.list.hide(i, u, r),
                    t.list.promise().done(function () {
            ...
            return this.dropdown.on({
                ...
                t.selectBox.on({
                    "change.selectBoxIt, internal-change.selectBoxIt": function (n, i) {
                        var u, f;
                        i || (u = t.list.find('li[data-val="' + t.originalElem.value + '"]'),
                            u.length && (t.listItems.eq(t.currentFocus).removeClass(t.focusClass),
                        ...
                        u.find("i").attr("class") && (t.dropdownImage.attr("class", u.find("i").attr("class")).addClass("selectboxit-default-icon"),
        ...
        _update: function (n) {
            var f, i, e, t = this,
                ...
                u = t.listItems.eq(t.currentFocus);
            "false" === n.attr("data-disabled") && (f = t.listItems.eq(t.currentFocus).attr("data-selectedtext"),
                i = u.attr("data-text"),
                e = i ? i : u.text(),
                (r && t.options.html ? t.dropdownText.html() === r : t.dropdownText.text() === r) && t.selectBox.val() === n.attr("data-val") ? t.triggerEvent("change") : (t.selectBox.val(n.attr("data-val")),
                    t.currentFocus = +n.attr("data-id"),
                    t.originalElem.value !== t.dropdownText.attr("data-val") && t.triggerEvent("change")))
        },
        _addClasses: function (n) {
            var t = this,
                i = (t.focusClass = n.focus,
                    t.hoverClass = n.hover,
                    n.button),
                r = n.list,
                u = n.arrow,
                f = n.container;
            return t.openClass = n.open,
                ...
                t.downArrow.addClass(t.selectBox.attr("data-downarrow") || t.options.downArrowIcon || u),
        ...
        _copyAttributes: function () {
            var n = this;
            return n._addSelectBoxAttributes && n._addSelectBoxAttributes(),
                n
        },
    ...
    u.add = function (t, i) {
        this._populate(t, function (t) {
            ...
            if (t && ("array" === f || c && s.data && "array" === n.type(s.data)) || "object" === f && t.data && "array" === n.type(t.data)) {
                for (r._isJSON(t) && (t = s),
                    t.data && (t = t.data),
                    h = t.length; h - 1 >= e; e += 1)
                    u = t[e],
                    n.isPlainObject(u) ? o.push(n("<option/>", u)) : "string" === n.type(u) && o.push(n("<option/>", {
                        text: u,
                        value: u
                    }));
                r.selectBox.append(o)
            } else
                t && "string" === f && !r._isJSON(t) ? r.selectBox.append(t) : t && "object" === f ? r.selectBox.append(n("<option/>", t)) : t && r._isJSON(t) && n.isPlainObject(r._parseJSON(t)) && r.selectBox.append(n("<option/>", r._parseJSON(t)));
    ...
    u._ariaAccessibility = function () {
        ...
        return t.dropdownContainer.attr({
            ...
            i.length && t.dropdownContainer.attr("aria-labelledby", i[0].id),
            t.list.attr({
                role: "listbox",
                "aria-hidden": "true"
            }),
    ...
    u._destroySelectBoxIt = function () {
        ...
        return t.dropdown.off(".selectBoxIt"),
            n.contains(t.dropdownContainer[0], t.originalElem) && t.dropdownContainer.before(t.selectBox),
    ...
    u.disableOption = function (t, i) {
        ...
        return "number" === o && (r.close(),
                ...
                r.currentFocus === t && (f = r.listItems.eq(r.currentFocus).nextAll("li").not("[data-disabled='true']").first().length,
    ...
    u._isDisabled = function () {
        var n = this;
        return n.originalElem.disabled && n.disable(),
            n
    };
    u._dynamicPositioning = function () {
        var t = this,
            e, o;
        if ("number" === n.type(t.listSize))
            ...
            (t.list.data("max-height") || t.list.data("max-height", t.list.outerHeight()),
                l) ? t.dropdown.offset().top - f >= i ? (t.list.css("max-height", i),
                t.list.css("top", t.dropdown.position().top - t.list.outerHeight())) : (e = Math.abs(s + r + i - (h + f)),
                o = Math.abs(t.dropdown.offset().top - f - i),
                o > e ? (t.list.css("max-height", i - e - r / 2),
                    t.list.css("top", "auto")) : (t.list.css("max-height", i - o - r / 2),
                    t.list.css("top", t.dropdown.position().top - t.list.outerHeight()))): (t.list.css("max-height", i),
                t.list.css("top", "auto"))
        }
        return t
    };
    ...
    u.enableOption = function (t, i) {
        var u, r = this,
            f = n.type(t);
        return "number" === f && (u = r.selectBox.find("option").eq(t),
    ...
    u.moveDown = function (n) {
        ...
        if (t.currentFocus += 1,
            ...
            if (i && r)
                return t.listItems.eq(t.currentFocus - 1).blur(),
                    t.moveDown(),
                    void 0;
            i && !r ? t.currentFocus -= 1 : (t.listItems.eq(t.currentFocus - 1).blur().end().eq(t.currentFocus).focusin(),
        ...
        if (t.currentFocus -= 1,
            ...
            if (i && r)
                return t.listItems.eq(t.currentFocus + 1).blur(),
                    t.moveUp(),
                    void 0;
            i && !r ? t.currentFocus += 1 : (t.listItems.eq(this.currentFocus + 1).blur().end().eq(t.currentFocus).focusin(),
                t._scrollToView("up"),
    ...
    u._setCurrentSearchOption = function (n) {
        var t = this;
        return (t.options.aggressiveChange || t.options.selectWhenHidden || t.listItems.eq(n).is(":visible")) && t.listItems.eq(n).data("disabled") !== !0 && (t.listItems.eq(t.currentFocus).blur(),
                t.currentIndex = n,
                t.currentFocus = n,
    ...
    u._searchAlgorithm = function (n, t) {
        for (var f, e, i = this, h = !1, s = i.textArray, u = i.currentText, r = n, o = s.length; o > r; r += 1) {
            for (e = s[r],
                ...
                1 !== s[f].search(t) && (h = !0,
                    f = o);
            if (h || (i.currentText = i.currentText.charAt(i.currentText.length - 1).replace(/[|()\[{.+*?$\\]/g, "\\$0"),
                    u = i.currentText),
                t = new RegExp(u, "gi"),
                u.length < 3) {
                if (t = new RegExp(u.charAt(0), "gi"),
                    -1 !== e.charAt(0).search(t))
                    return i._setCurrentSearchOption(r),
                        (e.substring(0, u.length).toLowerCase() !== u.toLowerCase() || i.options.similarSearch) && (i.currentIndex += 1),
                        !1
            } else if (-1 !== e.search(t))
                return i._setCurrentSearchOption(r),
                    !1;
            if (e.toLowerCase() === i.currentText.toLowerCase())
                return i._setCurrentSearchOption(r),
                    i.currentText = "",
                    !1
        }
    ...
    u.search = function (n, t, i) {
        ...
        return i ? r.currentText += n.replace(/[|()\[{.+*?$\\]/g, "\\$0") : r.currentText = n.replace(/[|()\[{.+*?$\\]/g, "\\$0"),
            ...
            u && r._searchAlgorithm(0, r.currentText),
    ...
    u._applyNativeSelect = function () {
        ...
        return n.dropdownContainer.append(n.selectBox),
            ...
            n.originalElem.disabled && n.triggerEvent("disable"),
            this
    };
    ...
    u._mobile = function () {
        var n = this;
        return n.isMobile && (n._applyNativeSelect(),
                n._mobileEvents()),
            this
    };
    u.remove = function (t, i) {
        var u, o, r = this,
            ...
            e = "";
        if ("array" === s) {
            for (o = t.length; o - 1 >= f; f += 1)
                u = t[f],
                "number" === n.type(u) && (e += e.length ? ", option:eq(" + u + ")" : "option:eq(" + u + ")");
            r.selectBox.find(e).remove()
        } else
            "number" === s ? r.selectBox.find("option").eq(t).remove() : r.selectBox.find("option").remove();
        return r.dropdown ? r.refresh(function () {
                r._callbackSupport(i)
            }, !0) : r._callbackSupport(i),
            r
    ...
    u.selectOption = function (t, i) {
        var r = this,
            u = n.type(t);
        return "number" === u ? r.selectBox.val(r.selectItems.eq(t).val()).change() : "string" === u && r.selectBox.val(t).change(),
            r._callbackSupport(i),
            r
    };
    ...
    u.setOptions = function (t, i) {
        var r = this;
        return n.isPlainObject(t) && (r.options = n.extend({}, r.options, t)),
            r.refresh(function () {
                r._callbackSupport(i)
            }, !0),
            r
