...
class SumBoxButtons extends React.Component {
  ...
  onExp() {
    ...
    if (urlLocation) {
      ...
      ajax_url =
        "https://pidrealty4.local/wp-content/themes/Realhomes-child-3/db/dbSaveCMAInfo.php";
    } else {
      ajax_url =
  ...
  onSaveSubjectInfo() {
    ...
    if (urlLocation) {
      ...
      ajax_url =
        "https://pidrealty4.local/wp-content/themes/Realhomes-child-3/db/dbAddSubjectProperty.php";
    } else {
      ajax_url =
