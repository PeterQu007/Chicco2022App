<div style="top:0px;left:0px;width:746px;height:17px;" id="" class="mls57">
  Detailed Tax Report{" "}
</div>;

//mls-taxdetails.js legacy code:
var ActualTotalsTopPosition =
  $('div:contains("Actual Totals"):last').position().top + 38;
...
var bcaDescriptionTopPosition = $(
  'div:contains("BCA Description"):last'
).position().top;
var bcaDataUpdateDateTopPosition = $(
  'div:contains("BCAData Update"):last'
).position().top;
...
switch (self.houseType) {
  ...
  case "Detached":
    ...
    self.landValue = $(
      `div[style="top:${ActualTotalsTopPosition}px;left:0px;width:246px;height:14px;"]`
    ).text();
    self.improvementValue = $(
      `div[style="top:${ActualTotalsTopPosition}px;left:250px;width:246px;height:14px;"]`
    ).text();
    self.totalValue = $(
      `div[style="top:${ActualTotalsTopPosition}px;left:500px;width:246px;height:14px;"]`
    ).text();
    self.planNum = $(
      `div[style="top:${PlanNumTopPosition}px;left:0px;width:79px;height:14px;"]`
    ).text();
    self.lotSize = $(
      `div[style="top:${LotSizeTopPosition}px;left:150px;width:221px;height:14px;"]`
    ).text();
    self.bcaDescription = $(
      `div[style="top:${bcaDescriptionTopPosition}px;left:150px;width:221px;height:14px;"]`
    ).text();
    self.bcaDataUpdateDate = $(
      `div[style="top:${bcaDataUpdateDateTopPosition}px;left:150px;width:221px;height:14px;"]`
    ).text();

    break;
}

TEST: PID: 030 - 825 - 954;
905 - 007 - 338;
